...
class ChatServerConnectionClosedException extends Exception {
}
            ...
            try {
                ...
                try {
                    ...
                    if ((getConnId() != -1) && (false == this.accepted)) { // initiate connection
                        ...
                        System.out.println("Could not parse integer from input");
                        throw new ChatServerConnectionClosedException();
                }
                ...
                while(true) {
                    ...
                    System.out.println(id+" transmitted to "+getConnId()+" :"+str);
                }
            } catch (IOException e) {
            } catch (ChatServerConnectionClosedException e) {
                try {
                    System.out.println("Client ID="+id+" connection closed");
                    ...
                    System.out.println("Socket count =  "+MyApp.socketCount);
                    in.close();
                    out.close();
                    socket.close();
                ...
                try {
                    System.out.println("Trying finally close ID="+id+" socket");
...
public class MyApp {
    ...
    public static void main(String args[]) throws IOException {    
            ...
            srvsck = new ServerSocket(PORT, backlog, InetAddress.getByAddress(new byte[] {0x00,0x00,0x00,0x00})); // listen on 0.0.0.0
